...
figure(1)
hold on
plot(sigma_range, err(:, 1) / total(2), 'Linewidth', 2.0)
plot(sigma_range, err_o(:, 1) / total(2), 'Linewidth', 2.0)
plot(sigma_range, err_oc(:, 1) / total(2), 'Linewidth', 2.0)
...
figure(2)
hold on
plot(sigma_range, err(:, 2) / total(1), 'Linewidth', 2.0)
plot(sigma_range, err_o(:, 2) / total(1), 'Linewidth', 2.0)
plot(sigma_range, err_oc(:, 2) / total(1), 'Linewidth', 2.0)
legend('binarization', 'opening', 'opening & closing', 'Location', 'southeast')
title('Type II error')
xlabel('sigma')
