...
folder = 'C:\Users\Domin\Dropbox\Masterarbeit\ROI-Detection\SIMULATION\CSV\';

% Reset RNG seed:
rng('default')

% Load input:
load('inputSIMULATION.mat');
...
for alpha = alphas
    ...
    for phi = phis
        ...
        cases = ErrorTestCases(dims, nr_pictures, cases, alpha_use, phi, max_nr_noise, max_sigma);
