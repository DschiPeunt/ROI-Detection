...
figure(1)
hold on
plot(sigma_range, err_Bon_1dd(:, 1) / t_1dd(1), 'Linewidth', 2.0)
plot(sigma_range, err_Bon_dA(:, 1) / t_dA(1), 'Linewidth', 2.0)
plot(sigma_range, err_FDR_1dd(:, 1) / t_1dd(1), 'Linewidth', 2.0)
plot(sigma_range, err_FDR_dA(:, 1) / t_dA(1), 'Linewidth', 2.0)
plot(sigma_range, err_Hoc_1dd(:, 1) / t_1dd(1), 'Linewidth', 2.0)
...
figure(2)
hold on
plot(sigma_range, err_Bon_1dd(:, 2) / t_1dd(2), 'Linewidth', 2.0)
plot(sigma_range, err_Bon_dA(:, 2) / t_dA(2), 'Linewidth', 2.0)
plot(sigma_range, err_FDR_1dd(:, 2) / t_1dd(2), 'Linewidth', 2.0)
plot(sigma_range, err_FDR_dA(:, 2) / t_dA(2), 'Linewidth', 2.0)
plot(sigma_range, err_Hoc_1dd(:, 2) / t_1dd(2), 'Linewidth', 2.0)
