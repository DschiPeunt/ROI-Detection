...
\begin{figure}[h!]
	...
	\begin{tikzpicture}
		\begin{axis}[
			...
			\draw (axis cs: 3.2452, 0) -- (axis cs: 3.2452, 0.95);
			\draw (axis cs: 0, 0.95) -- (axis cs: 3.2554, 0.95);
			\draw (axis cs: 4.2703, 0) -- (axis cs: 4.2703, 0.99);
			\draw (axis cs: 0, 0.99) -- (axis cs: 4.2791, 0.99);
			\filldraw (axis cs: 3.2452, 0.95) circle (2pt);
			\filldraw (axis cs: 4.2703, 0.99) circle (2pt);
		...
		\end{axis}
	\end{tikzpicture}
	\caption{Plot of the cumulative distribution function $p_1(t)$. The numerically computed thresholds $t_{0.05} = 3.2452$ and $t_{0.01} = 4.2703$ are marked.}
	\label{fig: cdf}
\end{figure}
	...
	\begin{subfigure}[t]{0.48\linewidth}
		...
		\begin{tikzpicture}
			\begin{axis}[
				...
				width=\linewidth,
				no marks]
				\addplot[line width=1pt,dashed,color=blue] table[x=sigma,y=probtypeI,col sep=comma]{CSV/Dimensions/resultsErrorTestCasesTypeI_128x128_relaxed.csv};
				\addlegendentry{Binarization}
				\addplot[line width=1pt,dashed,color=red] table[x=sigma,y=probtypeI,col sep=comma]{CSV/Dimensions/resultsErrorTestCasesTypeI_128x128_o_relaxed.csv};
				\addlegendentry{Opening}
				\addplot[line width=1pt,dashed,color=gray] table[x=sigma,y=probtypeI,col sep=comma]{CSV/Dimensions/resultsErrorTestCasesTypeI_128x128_oc_relaxed.csv};
				\addlegendentry{Opening \& Closing}
			\end{axis}
		\end{tikzpicture}
		\caption{Proportion of type I errors for images with size $128 \times 128$.}
		\label{fig: simulationresultstypeI_128_relaxed}
	\end{subfigure}
	\hfill
	\begin{subfigure}[t]{0.48\linewidth}
		\centering
		\begin{tikzpicture}
			\begin{axis}[
				...
				width=\linewidth,
				no marks]
				\addplot[line width=1pt,dashed,color=blue] table[x=sigma,y=probtypeII,col sep=comma]{CSV/Dimensions/resultsErrorTestCasesTypeII_128x128_relaxed.csv};
				\addlegendentry{Binarization}
				\addplot[line width=1pt,dashed,color=red] table[x=sigma,y=probtypeII,col sep=comma]{CSV/Dimensions/resultsErrorTestCasesTypeII_128x128_o_relaxed.csv};
				\addlegendentry{Opening}
				\addplot[line width=1pt,dashed,color=gray] table[x=sigma,y=probtypeII,col sep=comma]{CSV/Dimensions/resultsErrorTestCasesTypeII_128x128_oc_relaxed.csv};
				\addlegendentry{Opening \& Closing}
			\end{axis}
		\end{tikzpicture}
		\caption{Proportion of type II errors for images with size $128 \times 128$.}
		\label{fig: simulationresultstypeII_128_relaxed}
	\end{subfigure}
	\vfill
	\begin{subfigure}[t]{0.48\linewidth}
		\centering
		\begin{tikzpicture}
			\begin{axis}[
				...
				width=\linewidth,
				no marks]
				\addplot[line width=1pt,dashed,color=blue] table[x=sigma,y=probtypeI,col sep=comma]{CSV/Dimensions/resultsErrorTestCasesTypeI_256x256_relaxed.csv};
				\addlegendentry{Binarization}
				\addplot[line width=1pt,dashed,color=red] table[x=sigma,y=probtypeI,col sep=comma]{CSV/Dimensions/resultsErrorTestCasesTypeI_256x256_o_relaxed.csv};
				\addlegendentry{Opening}
				\addplot[line width=1pt,dashed,color=gray] table[x=sigma,y=probtypeI,col sep=comma]{CSV/Dimensions/resultsErrorTestCasesTypeI_256x256_oc_relaxed.csv};
				\addlegendentry{Opening \& Closing}
			\end{axis}
		\end{tikzpicture}
		\caption{Proportion of type I errors for images with size $256 \times 256$.}
		\label{fig: simulationresultstypeI_256_relaxed}
	\end{subfigure}
	\hfill
	\begin{subfigure}[t]{0.48\linewidth}
		\centering
		\begin{tikzpicture}
			\begin{axis}[
				...
				width=\linewidth,
				no marks]
				\addplot[line width=1pt,dashed,color=blue] table[x=sigma,y=probtypeII,col sep=comma]{CSV/Dimensions/resultsErrorTestCasesTypeII_256x256_relaxed.csv};
				\addlegendentry{Binarization}
				\addplot[line width=1pt,dashed,color=red] table[x=sigma,y=probtypeII,col sep=comma]{CSV/Dimensions/resultsErrorTestCasesTypeII_256x256_o_relaxed.csv};
				\addlegendentry{Opening}
				\addplot[line width=1pt,dashed,color=gray] table[x=sigma,y=probtypeII,col sep=comma]{CSV/Dimensions/resultsErrorTestCasesTypeII_256x256_oc_relaxed.csv};
				\addlegendentry{Opening \& Closing}
			\end{axis}
		\end{tikzpicture}
		\caption{Proportion of type II errors for images with size $256 \times 256$.}
		\label{fig: simulationresultstypeII_256_relaxed}
	\end{subfigure}
	\vfill
	\begin{subfigure}[t]{0.48\linewidth}
		\centering
		\begin{tikzpicture}
			\begin{axis}[
				...
				width=\linewidth,
				no marks]
				\addplot[line width=1pt,dashed,color=blue] table[x=sigma,y=probtypeI,col sep=comma]{CSV/Dimensions/resultsErrorTestCasesTypeI_512x512_relaxed.csv};
				\addlegendentry{Binarization}
				\addplot[line width=1pt,dashed,color=red] table[x=sigma,y=probtypeI,col sep=comma]{CSV/Dimensions/resultsErrorTestCasesTypeI_512x512_o_relaxed.csv};
				\addlegendentry{Opening}
				\addplot[line width=1pt,dashed,color=gray] table[x=sigma,y=probtypeI,col sep=comma]{CSV/Dimensions/resultsErrorTestCasesTypeI_512x512_oc_relaxed.csv};
				\addlegendentry{Opening \& Closing}
			\end{axis}
		\end{tikzpicture}
		\caption{Proportion of type I errors for images with size $512 \times 512$.}
		\label{fig: simulationresultstypeI_512_relaxed}
	\end{subfigure}
	\hfill
	\begin{subfigure}[t]{0.48\linewidth}
		\centering
		\begin{tikzpicture}
			\begin{axis}[
				...
				width=\linewidth,
				no marks]
				\addplot[line width=1pt,dashed,color=blue] table[x=sigma,y=probtypeII,col sep=comma]{CSV/Dimensions/resultsErrorTestCasesTypeII_512x512_relaxed.csv};
				\addlegendentry{Binarization}
				\addplot[line width=1pt,dashed,color=red] table[x=sigma,y=probtypeII,col sep=comma]{CSV/Dimensions/resultsErrorTestCasesTypeII_512x512_o_relaxed.csv};
				\addlegendentry{Opening}
				\addplot[line width=1pt,dashed,color=gray] table[x=sigma,y=probtypeII,col sep=comma]{CSV/Dimensions/resultsErrorTestCasesTypeII_512x512_oc_relaxed.csv};
				\addlegendentry{Opening \& Closing}
			\end{axis}
		\end{tikzpicture}
		\caption{Proportion of type II errors for images with size $512 \times 512$.}
		\label{fig: simulationresultstypeII_512_relaxed}
	\end{subfigure}
...
%	\end{align*}
	...
	\lstinputlisting[caption=\emph{MATLAB} implementation of an algorithm to randomly generate images with a rectangular region of interest with a checkerboard pattern.]{ROI-Detection/ROI_Generator.m}
	...
	\lstinputlisting[caption=\emph{MATLAB} implementation of the algorithm counting the errors for the randomly generated test images.]{ROI-Detection/SIMULATION/ErrorTestCases.m}
\end{appendix}
